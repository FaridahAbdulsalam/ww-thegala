...
[
    ...
    {id: 5,
        ...
        answer: "We’re not limiting the awards to any community in particular, if you believe you know someone who deserves the award then feel free to free to nominate them. We will however break the nominations down into finalists for each category based on how many times they have been nominated by others.",
    },
    {id: 6,
        question: "How will you pick winners for the awards?",
        answer: "We don’t. You do! As soon as we have the finalists we will release another round of voting and the winners will be announced on the night of the event.",
    },
    {id: 7,
        question: "Can I know more about the chosen donation recipients?",
        answer: "Yes. Please follow this link to find out more about the organizations we have chosen to support this year: [link]",
    },  
    {id: 8,
        question: "Can I buy tickets on the door?",
        answer: "Unfortunately not. We implore you to buy tickets in advance to avoid disappointment as we expect to sell out quickly and cannot accept people on the door due to the venue's capacity limits.",
    },
    {id: 9,
        question: "I want to donate to MFAF Youth, how do I do that?",
